...
dataset_fpaths = ["../datasets/dbpedia.tsv",
                  ...
                  "../datasets/entities.tsv"]

sl = SparseLinker("../data/tfidf-large", tfidf=True, stop_words=True)
...
context = "Linus Benedict Torvalds is a Finnish-American software engineer[2][6] who is the creator, and historically, the principal developer of the Linux kernel, which became the kernel for operating systems such as the Linux operating systems, Android, and Chrome OS."
